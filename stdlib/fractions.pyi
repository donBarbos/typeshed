...
class Fraction(Rational):
    ...
    @overload
    def __pow__(a, b: int, modulo: int | None = None) -> Fraction: ...
    @overload
    def __pow__(a, b: float | Fraction, modulo: float | Fraction | None = None) -> float: ...
    @overload
    def __pow__(a, b: complex, modulo: complex | None = None) -> complex: ...
    @overload
    def __rpow__(b, a: float | Fraction, modulo: float | Fraction | None = None) -> float: ...
    @overload
    def __rpow__(b, a: complex, modulo: complex | None = None) -> complex: ...
